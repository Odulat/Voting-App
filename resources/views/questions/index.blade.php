...
{{--                            <span class="block font-normal">создайте свой!</span>--}}
                        ...
                        <a href="{{ route('questions.create', ['id' => request()->route()->parameter('id')]) }}">
                            <x-button class="mt-5">
                                {{ __('Добавить вопрос') }}
                            </x-button>
                        </a>
                                ...
                                <div class="row">
                                    <div class="w-full lg:w-3/4">
                                        <div class="lg:mt-5 subscribe-content">
                                            <a href="{{ route('questions.show', ['id' => request()->route()->parameter('id'), 'question_id' => $question->id]) }}" class="text-xl subscribe-title">
                                                {{ $key + 1 }}. {{ data_get($question, 'text') }}
                                            </a>
                                        </div>
                                    </div>
                                </div>
